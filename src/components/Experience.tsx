      ...
      <motion.div>
        ...
        >
          <ul className="custom-list custom-list--checkbox">
            <li>Role change due to an acquisition of Swrve by MessageGears.</li>
            <li>
            ...
            <li>
              Experience working on two different codebases and build/deployment
              pipelines in tandem with a global team of developers.
            </li>
            <li>
        ...
        >
          <ul className="custom-list custom-list--checkbox">
            ...
            <li>
              ...
              Git, Docker. Testing via Jest and React Testing library, with E2E
              tests in Ruby (Rspec).
            </li>
          </ul>
        </ExperiencePanel>
        ...
        >
          <ul className="custom-list custom-list--checkbox">
            <li>Building fully functioning responsive websites, full stack.</li>
            <li>
              Maintaining and contributing to company wide dev stack and
              boilerplate systems, ensuring consistent working practices across
            ...
            <li>
              ...
              from initial discussions through to completion. (Scoping, quoting,
              managing timelines, managing scope creep, invoicing).
            </li>
            <li>
              HTML, CSS, SCSS, Javascript, jQuery, PHP, Wordpress custom
              Development, Bootstrap, CSS Grid, React, MySQL, Npm, Git,
              Bitbucket.
            </li>
          </ul>
        </ExperiencePanel>
